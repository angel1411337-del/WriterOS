...
Return ONLY a number between 1.0 and 10.0 (e.g., "7.5")"""),
        ...
        try:
            ...
            logger.warning(f"Invalid tension score returned: {result}, defaulting to 5.0")
            return 5.0
...
Return ONLY a number between 1.0 and 10.0 (e.g., "6.8")"""),
        ...
        try:
            ...
            logger.warning(f"Invalid emotion score returned: {result}, defaulting to 5.0")
            return 5.0
    ...
    async def analyze_scene(self, scene: Document, genre: str = "general") -> Document:
        ...
        logger.info(f"🎭 Analyzing scene: {scene.title}")
        ...
        logger.info(f"  Tension: {tension:.1f}/10, Emotion: {emotion:.1f}/10")
    ...
    async def analyze_chapter(self, chapter_scenes: List[Document], genre: str = "general") -> Dict[str, Any]:
        ...
        logger.info(f"🎭 Analyzing {len(chapter_scenes)} scenes")
